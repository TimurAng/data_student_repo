...
|[Прогнозирование температуры звезды](https://github.com/TimurAng/data_student_repo/tree/main/The_temperature_of_the_star)|Разработка модели нейросети с помощью которой можно будет определять температуру на поверхности обнаруженных звёзд.|Pandas|
