...
|[Прогнозирование рисков](https://https://github.com/TimurAng/data_student_repo/blob/main/predicting_risks/Linear_models_in_ML.ipynb)|Разработка модели машинного обучения, которая поможет заказчику управлять рисками и принимать объективное решение о покупке.|Pandas|
