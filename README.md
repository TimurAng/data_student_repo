...
|[Прогнозирование рисков](https://https://github.com/TimurAng/data_student_repo/blob/main/predicting_risks/Linear_models_in_ML.ipynb)|разработать модель машинного обучения, которая поможет ему управлять рисками и принимать объективное решение о покупке.|Pandas|
